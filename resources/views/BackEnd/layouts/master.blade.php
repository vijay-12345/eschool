      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="{{ $first_part== 'teacher' ? 'active' : ''}}">
           ...
           @if($role=='school')
          <li class="{{ $first_part== 'quiz' ||  $first_part== 'quiz-detail' || $first_part== 'quiz-results' ? 'active' : ''}}">
            <a href='{{url("/$role/quiz")}}'>
              <i class="now-ui-icons location_map-big"></i>
              <p>quiz</p>
            </a>
          </li>
          <li class="{{ $first_part== 'library-study-material' || $first_part== 'library-assignment' ? 'active' : ''}}">
              <a class="testflip d-flex flex-wrap" href='javascript:void(0);'>
              <i class="now-ui-icons design_app"></i>
              <p>Content Library </p>
              <i class="now-ui-icons arrows-1_minimal-down"></i>
               ...
               <div class="testpanel">
                    <a class="dropdown-item" href="{{url("/$role/library-study-material")}}">Study Material</a>
                    <a class="dropdown-item" href="{{url("/$role/library-assignment")}}">Assignments</a>
          ...
          <li class="{{ $first_part== 'session-attendance' || $first_part== 'session-attendance-by-student' ? 'active' : ''}}">
              <a class="testflip1 d-flex flex-wrap" href='javascript:void(0);'>
              <i class="now-ui-icons design_app"></i>
              <p>Attendance Report </p>
              <i class="now-ui-icons arrows-1_minimal-down"></i>
              
            </a>
               <div class="testpanel1">
                    <a class="dropdown-item" href="{{url("/$role/session-attendance")}}">By Session</a>
                    <a class="dropdown-item" href="{{url("/$role/session-attendance-by-student")}}">By Student</a>
